...
\texttt{Magnitude} & $N \times H \times W$ & Displacement magnitude $\sqrt{U^2 + V^2}$. \\ \hline
\texttt{Velocity} & $N \times H \times W$ & Velocity magnitude (frame-to-frame change / dt). \\ \hline
